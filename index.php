...
<div style="position:absolute; width:100%; height:10%; top:307.5%; left:0%; font-family: 'Poppins', sans-serif; font-size:18px;">
	<center><span style="position:relative; top:-30px; left:-50px;">Orlando Anderson - "You miss 100% of the shots you don't take."</span><img src="images/img8.png" width="100px" style="position:relative; left:-30px;"></center>
...
<br><span style="font-size:17px; float:right; margin-right:120px; margin-top:13px;">- L. Harshita Prasad</span>
</p>
...
box-shadow: 0px 3px 17px -11px rgba(0,0,0,0.63);border-radius:10px;">
